      ...
      <div class="col-lg-8 col-md-8 col-xs-12 col-sm-12">
        <q-card class="card-bg text-white">
          <q-card-section class="text-h6 ">
            <div class="text-h6">Đăng ký người dùng</div>
            <div class="text-subtitle2">Quản trị viên</div>
          </q-card-section>
          <q-card-section class="q-pa-sm">
            <q-list class="row">
              <q-item class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <q-item-section>
                  <q-btn label="Thêm ảnh" class="text-capitalize" rounded color="info"
              ...
              <q-item class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <q-item-section>
                  <q-input
                    ...
                    hint-color="white"
                    lazy-rules
                    :rules="[ val => val && val.length > 0 || 'Vui lòng nhập tài khoản']"
                  />    
                </q-item-section>
              </q-item>
              <q-item class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
              ...
              <q-item class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <q-item-section>
                  <q-input
                    ...
                    hint-color="white"
                    lazy-rules
                    :rules="[ val => val && val.length > 0 || 'Vui lòng nhập họ và tên']"
                  />  
                </q-item-section>
              </q-item>
              <q-item class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
        ...
        <q-card class="card-bg text-white">
          <q-card-section class="text-center bg-transparent">
            <q-avatar size="150px" class="shadow-10">
              <img src="https://gamek.mediacdn.vn/133514250583805952/2022/5/18/photo-1-16528608926331302726659.jpg">
            </q-avatar>
            <div class="text-subtitle2 q-mt-lg">by TQ</div>
            <div class="text-h6 q-mt-md">Monkey D. Luffy</div>
          </q-card-section>
          <q-card-section>
            <div class="text-body2 text-justify">
              ...
              đồng thời là một trong bốn chiến binh hàng đầu của băng. [25] Ước mơ cả đời của cậu là 
              trở thành Vua hải tặc bằng cách tìm ra kho báu huyền thoại được để lại bởi Vua hải tặc quá cố, Gol D. Roger . 
...
<style scoped>
.card-bg {
  background-image: linear-gradient(#1976d2, #e86f93);
}
</style>